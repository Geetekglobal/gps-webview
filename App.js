...
export default function App() { 
  const [url, setUrl] = useState('https://getpropertiessolutions.com/'); 
  ...
  registerNNPushToken(14619, 'CPm6MCgzyOoYYowUv0fJ8V'); 
  ...
  useEffect(() => { 
    async function getUnreadNots() { 
      let unreadCount = await getUnreadNotificationInboxCount(14619, 'CPm6MCgzyOoYYowUv0fJ8V'); 
  ...
  const handleGoToInbox = async () => { 
    let notifications = await getNotificationInbox(14619, 'CPm6MCgzyOoYYowUv0fJ8V'); 
